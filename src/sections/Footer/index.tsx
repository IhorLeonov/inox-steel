  ...
  return (
    <footer className="relative overflow-visible">
      <Container>
        ...
        <Inox className="mt-[48px] h-auto w-[167px] fill-white md:mt-20 md:w-[200px] xl:mt-[120px] xl:w-[230px]" />
      ...
      <div className="absolute bottom-[-10px] right-0 overflow-visible before:absolute before:inset-0 before:rounded-full before:bg-white/80 before:blur-[17vw] before:content-['']">
        <Image
          src="/images/footer/footer-mobile.png"
          width={434}
          height={396}
          alt="Стальна 3d фігура"
          className="relative z-10 h-auto w-[250px] opacity-90 md:hidden"
          unoptimized
        />
      </div>
    </footer>
